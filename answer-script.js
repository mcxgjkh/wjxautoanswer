// ============================
// V7.0.1 智能识别，修复选中，题库管理，正确率控制 Design By MCXGJKH
// ============================
...
(function() {
    ...
    console.log('V7.0.1 - 来自Electron的配置:', electronConfig);
    console.log('V7.0.1 - 正确率设置:', (accuracy * 100).toFixed(0) + '%');
    console.log('V7.0.1 - 基础信息填写题数:', electronBasicInfoCount);
    ...
    function createStatusBar() {
        ...
        statusBar.innerHTML = `
            <div class="left">
                <div class="title">问卷星自动答题器 V7.0.1</div>
    ...
    console.log('Electron版答题脚本 V7.0.1 初始化完成');
